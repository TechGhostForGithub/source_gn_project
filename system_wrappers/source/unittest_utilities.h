...
#ifndef GN_SYSTEM_WRAPPERS_SOURCE_UNITTEST_UTILITIES_H_
#define GN_SYSTEM_WRAPPERS_SOURCE_UNITTEST_UTILITIES_H_
...
class ScopedTracing {
 ...
 private:
  void StartTrace() {
    if (logging_) {
      Trace::CreateTrace();
      Trace::set_level_filter(gn::kTraceAll);
...
#endif  // GN_SYSTEM_WRAPPERS_SOURCE_UNITTEST_UTILITIES_H_
