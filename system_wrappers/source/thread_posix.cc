...
#define HAS_THREAD_ID !defined(CCORE_IOS) && !defined(CCORE_MAC)
...
bool ThreadPosix::Stop(bool& force)
{
	return Stop();
}

void ThreadPosix::SetThreadAfterFunc(ThreadAfterFunction afterFunc)
{
...
#endif
    GN_TRACE1(kTraceStateInfo, kTraceUtility, -1,
