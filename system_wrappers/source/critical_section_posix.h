...
#ifndef GN_SYSTEM_WRAPPERS_SOURCE_CRITICAL_SECTION_POSIX_H_
#define GN_SYSTEM_WRAPPERS_SOURCE_CRITICAL_SECTION_POSIX_H_
...
#endif  // GN_SYSTEM_WRAPPERS_SOURCE_CRITICAL_SECTION_POSIX_H_
