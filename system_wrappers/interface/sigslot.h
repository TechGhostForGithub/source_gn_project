...
//		PLATFORM NOTES
//
//			Win32						- On Win32, the OCS_WIN symbol must be #defined. Most mainstream
...
#ifndef OCS_BASE_SIGSLOT_H__
#define OCS_BASE_SIGSLOT_H__
...
#if defined(SIGSLOT_PURE_ISO) || (!defined(OCS_WIN) && !defined(__GNUG__) && !defined(SIGSLOT_USE_POSIX_THREADS))
#	define _SIGSLOT_SINGLE_THREADED
#elif defined(OCS_WIN)
#	define _SIGSLOT_HAS_WIN32_THREADS
#	if !defined(WIN32_LEAN_AND_MEAN)
#		define WIN32_LEAN_AND_MEAN
#	endif
#	include "ocs/base/win32.h"
