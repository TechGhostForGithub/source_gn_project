...
#ifndef GN_SYSTEM_WRAPPERS_INTERFACE_FIELD_TRIAL_H_
#define GN_SYSTEM_WRAPPERS_INTERFACE_FIELD_TRIAL_H_

#include <string>

#include "common_types.h"

// Field trials allow hj clients (such as Chrome) to turn on feature code
// in binaries out in the field and gather information with that.
//
// cctalk clients MUST provide an implementation of:
//
//   std::string gn::field_trial::FindFullName(const std::string& trial).
//
...
//
// Note: To keep things tidy append all the trial names with cctalk.
std::string FindFullName(const std::string& name);

}  // namespace field_trial
}  // namespace gn

#endif  // GN_SYSTEM_WRAPPERS_INTERFACE_FIELD_TRIAL_H_
