#ifndef GN_SYSTEM_WRAPPERS_INTERFACE_THREAD_WRAPPER_H_
#define GN_SYSTEM_WRAPPERS_INTERFACE_THREAD_WRAPPER_H_
...
#endif  // GN_SYSTEM_WRAPPERS_INTERFACE_THREAD_WRAPPER_H_
