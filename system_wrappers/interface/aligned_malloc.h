...
#ifndef GN_SYSTEM_WRAPPERS_INTERFACE_ALIGNED_MALLOC_H_
#define GN_SYSTEM_WRAPPERS_INTERFACE_ALIGNED_MALLOC_H_
...
#endif // GN_SYSTEM_WRAPPERS_INTERFACE_ALIGNED_MALLOC_H_
