...
#ifndef GN_SYSTEM_WRAPPERS_INTERFACE_SCOPED_VECTOR_H_
#define GN_SYSTEM_WRAPPERS_INTERFACE_SCOPED_VECTOR_H_

#include <assert.h>
#include <algorithm>
#include <vector>

#include "gn/system_wrappers/interface/stl_util.h"
#include "gn/system_wrappers/source/move.h"
...
template <class T>
class ScopedVector {
  GN_MOVE_ONLY_TYPE_FOR_CPP_03(ScopedVector, RValue)
...
#endif  // GN_SYSTEM_WRAPPERS_INTERFACE_SCOPED_VECTOR_H_
